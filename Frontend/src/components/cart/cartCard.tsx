...
const cartCard = () => {
     ...
     return (
          <div className="bg-white shadow-2xl rounded-[30px] py-5 px-6 mx-5 min-w-[260px] md:px-7 md:min-w-[312px] lg:mx-16 md:h-[450px] overflow-hidden">
               ...
               <div className="md:grid md:grid-cols-2 md:place-items-center">                    
                    <div className="scroll overflow-y-scroll max-h-[450px]">
                         {
                              cartItems.length === 0 ? (
                                   <div className="my-18 text-3xl font-medium md:text-4xl">No food items in your cart <FontAwesomeIcon icon={faHeartCrack} className="text-red-600 text-3xl" /></div>
                              ) : (
