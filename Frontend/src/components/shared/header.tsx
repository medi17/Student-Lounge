...
//           <div className="flex justify-between items-center m-5 py-3 px-7 bg-white shadow-sm rounded-[50px] lg:mx-16">
//                <h1 className="text-[24px] font-semibold text-Crimson">LOUNGE</h1>
//                <div className="nav active-nav flex justify-between items-center w-[60%]">
//                     <ul className={toggleState ?"nav active-nav flex justify-between items-center gap-8 text-[20px]" : "nav flex justify-between items-center gap-8 text-[20px]"} >
//                          <li className="hover:text-Crimson hover:text-[22px] hover:font-medium"><NavLink href="/">Home</NavLink></li>
//                          <li className="hover:text-Crimson hover:text-[22px] hover:font-medium"><a href="#about">About</a></li>
//                          <li className="hover:text-Crimson hover:text-[22px] hover:font-medium"><a href="#contact">Contact</a></li>
//                     </ul>
//                     <div className="">
