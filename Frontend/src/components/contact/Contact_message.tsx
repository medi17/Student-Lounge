          ...
          <div className="m-5 py-3 px-7 rounded-3xl lg:mx-16 md:flex md:justify-between md:gap-10 lg:gap-20">
               <div className="pt-5">
                    <div>
                         ...
                         <p className="my-4 font-light">Email, call or complete the form to reach us and give review</p>
                         <h3 className="mb-4 font-light">sixkilolounge@gmail.com</h3>
                         <h3 className="mb-4 font-light">+251-987-654-321</h3>
                    </div>
